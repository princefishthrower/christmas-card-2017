    ...
    return (
        <div>
          ...
          <div className="container">
            <a className="navbar-brand" href="#">Happy Holidays from Chris and Veronika!</a>
          </div>
        </nav>
        <div className="container">
          <div className="row">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12 mx-auto">
              <img className="img-fluid wiggle-veronika" src={veronika}/>
            </div>
            <div className="col-lg-4 col-md-12 mx-auto">
              <img className="img-fluid wiggle-chris" src={chris}/>
            </div>
            <div className="col-lg-2 col-md-12 mx-auto">
